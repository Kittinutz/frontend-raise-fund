...
export function RoundDetailPage({ roundId, onNavigate }: RoundDetailPageProps) {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <Card className="max-w-md">
          ...
          <CardContent>
            <p className="text-gray-600 mb-4">The investment round you're looking for doesn't exist.</p>
  ...
  const handleAuthorize = () => {
    ...
    toast.success('USDT authorization successful! You can now confirm your investment.');
  };
  ...
  const handleInvest = () => {
    ...
    toast.success(`Successfully invested ${tokenAmount} tokens (${calculatedUSDT.toLocaleString()} USDT)!`);
    setTokenAmount('1');
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <CardContent className="pt-6">
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
              <div>
                ...
                <p className="text-2xl text-primary">{round.dividendPercentage}%</p>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">{round.tokensRemaining} remaining</p>
              </div>
              <div>
                <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-xs text-gray-500">
                  Investment ends: {new Date(round.investmentEndDate).toLocaleDateString()}
                </p>
              </div>
            </div>
            ...
            <div>
              <div className="flex justify-between text-sm mb-2">
                ...
                <span className="text-gray-900">{progressPercentage.toFixed(1)}%</span>
              </div>
        ...
        <Tabs defaultValue="invest" className="w-full">
          <TabsList className="grid w-full grid-cols-2 lg:grid-cols-4 mb-8">
            ...
            <TabsTrigger value="dividends">Dividends ({dividends.length})</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="invest">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Purchase tokens for this investment round. Each token represents one cow.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                {round.status !== 'Open' && (
                  <Alert>
                    ...
                    <AlertDescription>
                      This round is currently {round.status.toLowerCase()} and not accepting new investments.
                    </AlertDescription>
                  </Alert>
                )}
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-primary/5 p-4 rounded-lg">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-lg">${round.tokenPrice.toLocaleString()} USDT</span>
                    </div>
                  ...
                  <div className="space-y-3">
                    <Button
                      ...
                      disabled={round.status !== 'Open' || isAuthorized || !tokenAmount || parseFloat(tokenAmount) <= 0}
                    ...
                    {dividends.map((dividend) => (
                      ...
                      >
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <p className="font-medium">{dividend.type} Dividend</p>
                            <p className="text-sm text-gray-500">
                              Payment Date: {new Date(dividend.date).toLocaleDateString()}
                            </p>
                          </div>
                        </div>
                        <div className="text-right">
                          ...
                          <Badge className={getDividendStatusColor(dividend.status)}>
                            {dividend.status}
                          </Badge>
                        </div>
                      </div>
